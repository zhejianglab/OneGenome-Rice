...
# ================begin to edit================
export WANDB_NAME=AgriGenome_1B_stage2_8k
SEQ_LENGTH=8192
MAX_LENGTH=1048576
TRAIN_SAMPLES=52943999
LAST_TRAIN_SAMPLES=40191535
LR_DECAY_SAMPLES=$(((TRAIN_SAMPLES - LAST_TRAIN_SAMPLES) * 80 / 100))
CHECKPOINT_PATH=/mnt/rice/AgriGenome_1B_stage2_8k/$WANDB_NAME
# ================end================
...
DATA_ARGS=" \
    ...
    --data-path /mnt/rice/stage2_8k/positive/02428.genome_8k_text_document 
    --split 1000,0,0 \
    --loss-mask-tokens N \
...
LOGGING_ARGS=" \
    ...
    --no-load-optim \
    --no-load-rng \
    --load /mnt/rice/AgriGenome_1B_1M \
    --log-throughput"
