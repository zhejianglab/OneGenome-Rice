...
# ================begin to edit================
export WANDB_NAME=AgriGenome_1B_128k
SEQ_LENGTH=131072
MAX_LENGTH=131072
TRAIN_SAMPLES=40128485
LAST_TRAIN_SAMPLES=39247926
LR_DECAY_SAMPLES=$(((TRAIN_SAMPLES - LAST_TRAIN_SAMPLES) * 80 / 100))
CHECKPOINT_PATH=//mnt/rice/AgriGenome_1B_128k/$WANDB_NAME
# ================end================
...
DATA_ARGS=" \
    ...
    --data-path /mnt/rice/128k/positive/13-65_128k_text_document 
    --split 1000,0,0 \
    --loss-mask-tokens N \
...
LOGGING_ARGS=" \
    ...
    --no-load-optim \
    --no-load-rng \
    --load /mnt/rice/AgriGenome_1B_32k \
    --log-throughput"
