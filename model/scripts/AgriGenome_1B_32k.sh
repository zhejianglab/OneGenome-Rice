...
# ================begin to edit================
export WANDB_NAME=AgriGenome_1B_32k
SEQ_LENGTH=32768
MAX_LENGTH=32768
TRAIN_SAMPLES=39247926
LAST_TRAIN_SAMPLES=34612595
LR_DECAY_SAMPLES=$(((TRAIN_SAMPLES - LAST_TRAIN_SAMPLES) * 80 / 100))
CHECKPOINT_PATH=/mnt/rice/AgriGenome_1B_32k/$WANDB_NAME
# ================end================
...
DATA_ARGS=" \
    ...
    --data-path /mnt/rice/32k/positive/W1556.transfer.merge.chr.fasta_3k_text_document 
    --split 1000,0,0 \
    --loss-mask-tokens N \
...
LOGGING_ARGS=" \
    ...
    --no-load-optim \
    --no-load-rng \
    --load /mnt/rice/AgriGenome_1B_8k \
    --log-throughput" 
