...
# ================begin to edit================
export WANDB_NAME=AgriGenome_1B_8k
SEQ_LENGTH=8192
MAX_LENGTH=8192
TRAIN_SAMPLES=34612595
LAST_TRAIN_SAMPLES=0
LR_DECAY_SAMPLES=$(((TRAIN_SAMPLES - LAST_TRAIN_SAMPLES) * 80 / 100))
CHECKPOINT_PATH=/mnt/rice/AgriGenome_1B_8k/$WANDB_NAME
# ================end================
...
DATA_ARGS=" \
    ...
    --data-path /mnt/rice/8k/positive/02428.genome.fa_3k_text_document 
    --split 1000,0,0 \
    --loss-mask-tokens N \
